...
exports.validateSeoMetaUpdate = void 0;
const joi_1 = __importDefault(require("joi"));
const HttpMessage_1 = require("@src/utils/HttpMessage");
const validateSeoMetaUpdate = (req, res, next) => {
...
exports.validateSeoMetaUpdate = validateSeoMetaUpdate;
const seoMetaValidationSchema = joi_1.default.object({
    pageTitle: joi_1.default.string().trim().optional(),
